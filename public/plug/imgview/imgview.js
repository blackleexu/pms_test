...
//                console.log(event.deltaY, event.deltaFactor, event.originalEvent.deltaMode, event.originalEvent.wheelDelta);
    ...
    function getImgViewSrc()
    {
        return 'url("'+cur_js_path+'/images/imgview.png")';
    }
...
//                'overflow':'hidden',
        ...
        loading.prop('src',cur_js_path+'/images/c_load.gif');
